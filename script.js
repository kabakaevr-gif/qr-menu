...
const menuData = [
    ...
    items: [
      {
        ...
        price: 5500,
        story: {
          ru: 'Тёплый салат с телятиной — популярное блюдо, сочетающее нежную телятину, свежие овощи и ароматные травы. Оно происходит из европейской кухни и балансирует насыщенный вкус мяса с лёгкостью зелени и орехов. Подавать лучше тёплым как лёгкую закуску или основное блюдо.',
          en: 'Warm veal salad is a popular dish combining tender grilled veal with fresh vegetables and aromatic herbs. It originates from European cuisine, balancing the richness of meat with light greens and nuts. It\'s best served warm as an appetiser or light main course.',
          kz: 'Тёплый салат с телятиной — нәзік бұқпа етін жаңа көкөністер және хош иісті шөптермен үйлестіретін танымал тағам. Бұл еуропалық асхана тағамы, еттің бай дәмін жеңіл көкпен және жаңғақтармен теңестіреді. Тағамды жылы күйде жеуге болады.',
        },
  ...
  },
  {
    ...
    items: [
      ...
      {
        name: { ru: 'Guinness Stout', en: 'Guinness Stout', kz: 'Guinness Stout' },
        description: { ru: '', en: '', kz: '' },
        price: 3800,
        story: {
          ru: 'Guinness Stout — легендарный ирландский тёмный эль, который начал варить Артур Гиннесс в Дублине в 1759 году. Он отличается насыщенными нотами жареного ячменя, карамели и кофе, а также плотной кремовой пеной. Пить Guinness лучше всего из стакана, наклоняя его для сохранения пены, и сочетать с мясными блюдами и сырами.',
          en: 'Guinness Stout is a legendary Irish dark beer first brewed by Arthur Guinness in Dublin in 1759. It features rich flavours of roasted barley, caramel and coffee, and a thick creamy head. Guinness is best enjoyed from a pint glass, poured at an angle to preserve the head, and paired with meat dishes and cheeses.',
          kz: 'Guinness Stout — 1759 жылы Дублинде Артур Гиннесс бастап шығарған әйгілі ирланд қара элі. Оның дәмінде қуырылған арпа, карамель және кофе ноталары бар, азотпен құйылатындықтан қалың кремді көбік пайда болады. Guinness-ті әйнек стақаннан, пішінді шамалы еңкейтіп құйып, ет тағамдары мен ірімшіктермен бірге ішу ұсынылады.',
        },
      },
  ...
  },
  {
    ...
    items: [
      {
        name: { ru: 'Jameson Original', en: 'Jameson Original', kz: 'Jameson Original' },
        description: { ru: '', en: '', kz: '' },
        price: 3500,
        story: {
          ru: 'Jameson Original — знаменитый ирландский виски, история которого начинается в 1780 году, когда Джон Джеймсон основал свою винокурню в Дублине. Этот виски тройной дистилляции, выдержанный в дубовых бочках, отличается мягким характером и нотами специй и ванили. Лучший способ насладиться Jameson — пить его чистым, со льдом или в классических коктейлях вроде Irish coffee.',
          en: 'Jameson Original is a famous Irish whiskey whose history dates back to 1780 when John Jameson founded his distillery in Dublin. Triple distilled and matured in oak casks, it has a smooth character with notes of spice and vanilla. It\'s best enjoyed neat, on the rocks, or in classic cocktails such as Irish coffee.',
          kz: 'Jameson Original — әйгілі ирланд вискиі, оның тарихы 1780 жылы Джон Джеймсон Дублинде винокурнясын құрған кезде басталады. Үш рет дистилляция жасалған және емен бөшкелерде пісірілген бұл виски жұмсақ дәмге ие және дәмдеуіш пен ваниль ноталары бар. Jameson-ды таза күйінде, мұз қосып немесе Irish coffee сияқты коктейльдерде ішкен дұрыс.',
        },
      },
      {
        name: { ru: 'Monkey Shoulder', en: 'Monkey Shoulder', kz: 'Monkey Shoulder' },
        description: { ru: '', en: '', kz: '' },
        price: 5500,
        story: {
          ru: 'Monkey Shoulder — купажированный односолодовый виски от William Grant & Sons, изготовленный из солодов Glenfiddich, Balvenie и Kininvie. Своё название он получил в честь болезни, от которой страдали солодильщики, переворачивавшие солод вручную. Виски выдерживается в бочках из-под бурбона, обладает ванильными и фруктовыми нотами. Monkey Shoulder хорош как в чистом виде, так и в коктейлях, таких как Old Fashioned.',
          en: 'Monkey Shoulder is a blended malt whisky from William Grant & Sons, made from malts from Glenfiddich, Balvenie and Kininvie. Its name comes from a condition that afflicted maltsters who turned barley by hand. Matured in ex-bourbon barrels, it offers vanilla and fruity notes. Monkey Shoulder is enjoyable neat or in cocktails like the Old Fashioned.',
          kz: 'Monkey Shoulder — William Grant & Sons компаниясының аралас солод вискиі, Glenfiddich, Balvenie және Kininvie солодтарынан жасалады. Атауы қолмен солодты аударған кезде жұмысшылардың иық ауруынан шыққан. Бурбон бөшкелерінде пісіп, ваниль және жеміс ноталары бар. Monkey Shoulder-ды таза немесе Old Fashioned сияқты коктейльдерде ішкен жақсы.',
        },
      },
      {
        name: { ru: 'Macallan 12', en: 'Macallan 12', kz: 'Macallan 12' },
        description: { ru: '', en: '', kz: '' },
        price: 7500,
        story: {
          ru: 'Macallan 12 — шотландский односолодовый виски, выдержанный в бочках из-под хереса в течение двенадцати лет. Винокурня Macallan основана в 1824 году и известна использованием отборного ячменя и традиционных маленьких медных перегонных кубов. Этот виски характеризуется богатым вкусом сухофруктов, дуба и специй. Его рекомендуют пить чистым или с каплей воды, чтобы раскрыть аромат.',
          en: 'Macallan 12 is a Scottish single malt aged for twelve years in sherry-seasoned oak casks. Founded in 1824, Macallan is known for using select barley and small copper stills. The whisky is rich in dried fruit, oak and spice flavours. It\'s best enjoyed neat or with a drop of water to open up the aroma.',
          kz: 'Macallan 12 — шери бөшкелерінде он екі жыл бойы пісетін шотландиялық бір солод вискиі. 1824 жылы құрылған Macallan винокурнясы таңдаулы арпа мен шағын мыс қазандарын қолданумен танымал. Бұл вискидің дәмінде кептірілген жемістер, емен және дәмдеуіштер бар. Ароматты ашу үшін Macallan-ды таза күйінде немесе бір тамшы сумен ішуге кеңес береді.',
        },
      },
      {
        name: { ru: "The Glenlivet Founder's Reserve", en: "The Glenlivet Founder's Reserve", kz: "The Glenlivet Founder's Reserve" },
        description: { ru: '', en: '', kz: '' },
        price: 4500,
        story: {
          ru: 'The Glenlivet Founder’s Reserve — односолодовый скотч, созданный в честь основателя винокурни Джорджа Смита, который в 1824 году первым получил лицензию на законное производство виски в долине Спей. Виски выдерживается в американских дубовых бочках первой и повторной наполняемости, благодаря чему обладает легким фруктовым ароматом с цитрусовыми нотами. Его можно пить чистым, со льдом или в коктейлях.',
          en: 'The Glenlivet Founder’s Reserve is a single malt created in honour of founder George Smith, who in 1824 was the first distiller to gain a legal licence in the Spey Valley. Matured in a mix of first-fill and traditional American oak casks, it delivers a light, fruity whisky with citrus notes. It’s enjoyable neat, on the rocks or in cocktails.',
          kz: 'The Glenlivet Founder’s Reserve — негізін қалаушы Джордж Смиттің құрметіне жасалған бір солод виски. 1824 жылы ол Spey аңғарында заңды лицензия алған бірінші винокур болды. Виски жаңа және ескі американ емен бөшкелерінде пісіп, жеңіл және цитрусты ноталары бар жемісті дәм береді. Оны таза, мұзбен немесе коктейльдерде ішеді.',
        },
      },
      {
        name: { ru: 'Chivas Regal 12', en: 'Chivas Regal 12', kz: 'Chivas Regal 12' },
        description: { ru: '', en: '', kz: '' },
        price: 4500,
        story: {
          ru: 'Chivas Regal 12 — один из самых известных шотландских купажей, созданный братьями Чивас. Его история начинается в XIX веке, когда они поставляли элитные спирты королевскому двору. В купаже используются выдержанные зерновые и солодовые виски, что придаёт напитку гармоничные ноты трав, меда и фруктов. Chivas Regal традиционно пьют чистым, со льдом или в коктейлях типа Whisky Sour.',
          en: 'Chivas Regal 12 is one of the best-known Scotch blends created by the Chivas brothers. Its history dates back to the 19th century when they supplied premium spirits to the royal court. The blend combines aged grain and malt whiskies, giving the drink harmonious notes of herbs, honey and fruit. Chivas Regal is traditionally enjoyed neat, with ice or in cocktails such as the Whisky Sour.',
          kz: 'Chivas Regal 12 — Chivas бауырлары жасаған ең танымал шотланд купаждарының бірі. Оның тарихы XIX ғасырда басталады, бауырлар патша сарайы үшін элиталық спирттер жеткізген. Купажда жасы сақталған дән және солод вискилері қолданылады, сондықтан дәмінде шөп, бал және жеміс ноталары бар. Chivas Regal-ды таза күйінде, мұзбен немесе Whisky Sour сияқты коктейльдерде ішеді.',
        },
      },
      {
        name: { ru: 'The Balvenie 12 Doublewood', en: 'The Balvenie 12 Doublewood', kz: 'The Balvenie 12 Doublewood' },
        description: { ru: '', en: '', kz: '' },
        price: 8500,
        story: {
          ru: 'The Balvenie 12 Doublewood — односолодовый виски, выдерживающийся сначала в бочках из-под бурбона, а затем в хересных бочках. Такое двойное созревание придаёт ему ванильные, медовые и пряные оттенки. Винокурня The Balvenie, основанная в 1892 году, выращивает собственный ячмень и использует традиционные солодовни. Этот виски лучше всего пить чистым или с каплей воды.',
          en: 'The Balvenie 12 Doublewood is a single malt whisky matured first in ex-bourbon barrels and then finished in sherry casks. This double maturation lends it vanilla, honey and spice. The Balvenie distillery, founded in 1892, grows its own barley and uses traditional maltings. This whisky is best savoured neat or with a drop of water.',
          kz: 'The Balvenie 12 Doublewood — алдымен бурбон бөшкелерінде, кейін шери бөшкелерінде пісетін бір солод виски. Мұндай қосарлы жетілу оған ваниль, бал және дәмдеуіштер береді. 1892 жылы құрылған The Balvenie винокурнясы өз арпасын өсіріп, дәстүрлі еденді солодтау тәсілін қолданады. Вискиді таза күйінде немесе бір тамшы сумен ішуге болады.',
        },
      },
    ],
  },
 ...
 */
/**
 * Open the full-size image modal. If an image source is provided it will
 * display the image; otherwise the image element is hidden. A descriptive
 * story can also be shown beneath the image when supplied. This allows
 * items such as premium whiskies or beers to include a brief history
 * and serving recommendation. When no story is provided, the description
 * container is hidden to avoid empty whitespace.
 *
 * @param {string} src    The data URI or path for the image. Can be empty.
 * @param {string} alt    Alternative text for the image.
 * @param {string} story  Optional descriptive text to display below the image.
 */
function openImageModal(src, alt, story) {
  const modal = document.getElementById('image-modal');
  const modalImg = document.getElementById('image-modal-img');
  const modalDesc = document.getElementById('image-modal-desc');
  // Set the image source and alt. Hide the image if there is no source.
  if (src) {
    modalImg.src = src;
    modalImg.alt = alt;
  ...
  // If a story is provided, populate and show the description; otherwise hide it.
...
function closeImageModal() {
  ...
  // Remove the image to free memory and hide the element
  modalImg.src = '';
  modalImg.alt = '';
  modalImg.style.display = 'none';
  // Clear and hide the description text
  modalDesc.textContent = '';
  modalDesc.style.display = 'none';
}
  ...
  menuData.forEach((category) => {
    ...
    filteredItems.forEach((item) => {
      ...
      if (item.image) {
        ...
        // When the image itself is clicked, open the full-size modal and story.
        imgEl.addEventListener('click', (event) => {
          // Prevent the click from bubbling to the parent item if needed
          event.stopPropagation();
          const storyText = item.story
            ? (item.story[currentLang] || item.story['ru'] || '')
            : '';
          openImageModal(item.image || '', itemName, storyText);
        });
      }
      ...
      // If the item has an image or a story, allow the entire row to open
      // the modal when clicked. This makes it possible to tap anywhere on
      // the row to view the photo and/or read a description. Change the
      // cursor to pointer to indicate that the row is clickable.
      if (item.image || item.story) {
